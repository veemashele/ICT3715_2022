...
<li><a href="stud.php"><i class="fa fa-question-circle"></i>My Students</a></li>
...
<li><a href="vi_mod.php" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>View Info</a></li>
<li><a href="stud.php" class=" hvr-bounce-to-right"><i class="fa fa-question-circle nav_icon"></i>My Students</a></li>
